...
linkTitle: "Run SVE without capable hardware"
type: docs
weight: 30
hide_summary: true
description: >
    Introduction to the Arm Instruction Emulator (Armie) to run SVE application on any Arm v8-A system.
---

## Arm Instruction Emulator

Download and install the [Arm Instruction Emulator](https://developer.arm.com/downloads/-/arm-instruction-emulator) on any Arm v8-A system. The Arm Instruction Emulator intercepts and emulates unsupported SVE instructions. It also support plugins for application analysis.
...
In this list, we see SVE instructions identified in the previous tutorial [Compile for SVE](/hpc/port_to_sve/sve_compile). In the main loop, they are executed 16 times to compute the addition of 127 array elements (16 batches of 512-bit SVE instructions).
...
Read the blog [here](https://community.arm.com/arm-community-blogs/b/high-performance-computing-blog/posts/optimizing-hpcg-for-arm-sve) to know more about how SVE and Armie help optimize real HPC workloads.
